...
\chapter*{Introduction et objectifs du stage}
  ...
  \vspace{0.5cm}
    ...
    \addcontentsline{toc}{section}{Objectifs du stage}
...
\verbfile{README_TXT/README_EDI_construction_P.txt}
...
\verbfile{README_TXT/README_EDI_construction_L.txt}
...
\vspace{1.5cm}
\verbfile{README_TXT/README_REF_repere.txt}
...
\subfigure{%
\label{fig:graphics:b}% label for subfigure
\includegraphics[width=\linewidth]{images/Annexes/modelbuilder/modèle_FME-1.jpg}}%
\caption{ModelBuilder d'ArcGIS pour le traitement des couches de contour des communes}%
\textit{Commentaire éventuel}
\end{sidewaysfigure}
...
\verbfile{README_TXT/README_arbre_caracteristique.txt}
\verbfile{README_TXT/README_occupation_S.txt}
\verbfile{README_TXT/README_limite_vegetale.txt}
...
\verbfile{README_TXT/README_limite_eau.txt}
...
\verbfile{README_TXT/README_point_eau.txt}
...
\verbfile{README_TXT/README_HYD_surface_eau.txt}
...
\subfigure{%
\label{fig:graphics:b}% label for subfigure
\includegraphics[width=\linewidth]{images/Annexes/modelbuilder/Modèle HYD_SURFACE_EAU.png}}%
...
\verbfile{README_TXT/README_HYD_troncon_eau.txt}
...
\subfigure{%
\label{fig:graphics:b}% label for subfigure
\includegraphics[width=\linewidth]{images/Annexes/modelbuilder/hydro.png}}%
...
\subfigure{%
\label{fig:graphics:b}% label for subfigure
\includegraphics[width=\linewidth]{images/Annexes/modelbuilder/Modèle HYD_TRONCONS.png}}%
...
\begin{sidewaysfigure}[!h]
\centering
\includegraphics[width=\linewidth]{images/Annexes/Resultat/Carte_25000_v4-1.png}%
...
\begin{sidewaysfigure}[!h]
\centering
\includegraphics[width=\linewidth]{images/Annexes/Resultat/Carte_50000_v3.pdf}%
\caption{Echantillon résultat (version 2) }
...
\begin{figure}[!h]
\centering
\includegraphics[width=\linewidth]{images/Annexes/Resultat/Carte_100000_A4.pdf}
...
\begin{sidewaysfigure}[!h]
\centering
\includegraphics[width=\linewidth]{images/Annexes/Resultat/Carte_100000_v0.pdf}%
\caption{Echantillon résultat (version 1) }
\colorbox{orange!10}{Echelle 1/100 000}
\label{100 000 v2}% label for figure
\end{sidewaysfigure}
...
\begin{sidewaysfigure}[!h]
\centering
\includegraphics[width=\linewidth]{images/Annexes/Resultat/Carte_250000_v1.pdf}%
\caption{Echantillon résultat (version 1) }
\colorbox{red!10}{Echelle 1/250 000}
\label{100 000 v2}% label for figure
\end{sidewaysfigure}
...
\caption{Echantillon résultat (version 1) }
\colorbox{black!10}{Echelle 1/500 000}
\label{500000 v2}% label for figure
\end{sidewaysfigure}
